<%@ Page Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="CFviewfeeback.aspx.cs" Inherits="CFviewfeeback" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        <td style="height: 22px;">
            &nbsp;</td>
        <td style="height: 22px;">
            <cc1:ZedGraphWeb ID="g1" runat="server" Height="400" Width="800">
